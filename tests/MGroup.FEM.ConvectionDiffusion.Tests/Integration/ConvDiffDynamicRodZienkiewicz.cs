...
{
    public class ConvDiffDynamicRodZienkiewicz
    {
        [Fact]
        private void RunTest()
        {
            ...
            var analyzerBuilder = new NewmarkDynamicAnalyzer.Builder(algebraicModel, problem, linearAnalyzer, timeStep: 0.5, totalTime: 10);
